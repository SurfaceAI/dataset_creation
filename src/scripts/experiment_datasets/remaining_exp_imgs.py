...
#label all of v101: ("true / false image labeling)"
...
exp_0 = pd.read_csv("/Users/alexandra/Nextcloud-HTW/SHARED/SurfaceAI/data/mapillary_images/automated_labeling_experiments/gpt_experiments/results/experiment_1_V101_asphalt_bad.csv", dtype={"image_id": str})
exp_1 = pd.read_csv("/Users/alexandra/Nextcloud-HTW/SHARED/SurfaceAI/data/mapillary_images/automated_labeling_experiments/gpt_experiments/results/experiment_1_V101_paving_stones_intermediate.csv", dtype={"image_id": str})
exp_2 = pd.read_csv("/Users/alexandra/Nextcloud-HTW/SHARED/SurfaceAI/data/mapillary_images/automated_labeling_experiments/gpt_experiments/results/experiment_1_V101_paving_stones_bad.csv", dtype={"image_id": str})
...
destination_path = f"/Users/alexandra/Nextcloud-HTW/SHARED/SurfaceAI/data/mapillary_images/training/V101/batch_3"
...
for i in tqdm(range(len(df))):
    ...
    origin_folder_path = f"/Users/alexandra/Nextcloud-HTW/SHARED/SurfaceAI/data/mapillary_images/training/V101/unsorted_images"
...
utils.crop_frame_for_img_folder(
        f"/Users/alexandra/Nextcloud-HTW/SHARED/SurfaceAI/data/mapillary_images/training/V101/batch_3",
        f"/Users/alexandra/Nextcloud-HTW/SHARED/SurfaceAI/data/mapillary_images/training/V101/batch_3_crop",
    )
