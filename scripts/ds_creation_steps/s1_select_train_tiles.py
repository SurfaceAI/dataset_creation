...
# setting path
sys.path.append("./")
import osm_tag_counts_as_raster as otag
from mapillary_image_counts_per_tile import mapillary_image_counts_per_tile
...
def select_train_tiles(exclude_cities):
    ...
    for surface in config.surfaces:
        for smoothness in config.surf_smooth_comb[surface]:
            ...
            temp_sampled_tiles = tiles[tiles.tile_id.isin(sampled_tile_ids)]
